...
namespace usporediXMLsaLINQ
{
    internal class Program
    {
        static void Main(string[] args)
        {
            XElement PrviXML = XElement.Load(@"C:\Users\ucenik\source\repos\usporediXMLsaLINQ\usporediXMLsaLINQ");
            XElement DrugiXML = XElement.Load(@"C:\Users\ucenik\source\repos\usporediXMLsaLINQ\usporediXMLsaLINQ");
            int brojpomagalo = 0;
